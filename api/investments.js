...
export default async function handler(req, res) {
    ...
    try {
        ...
        if (endpoint === 'transactions') {
            ...
            return await handleInvestmentTransactions(req, res, userId);
        } else {
            // Handle portfolio investments (default)
            return await handlePortfolioInvestments(req, res, userId);
        }
...
// Handle portfolio investments
async function handlePortfolioInvestments(req, res, userId) {
    if (req.method === 'GET') {
...
// Handle investment transactions
async function handleInvestmentTransactions(req, res, userId) {
    if (req.method === 'GET') {
